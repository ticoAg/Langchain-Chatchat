...
class OpenAILikeEmbeddings(BaseModel, Embeddings):
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_community.embeddings import OpenAILikeEmbeddings
            OpenAILikeEmbeddings(
                model="BAAI/bge-small",
                openai_api_base="http://localhost:7997",
            )
    """
    ...
    openai_api_base: str = "http://localhost:7997"
    """Endpoint URL to use."""
