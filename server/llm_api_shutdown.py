...
base_shell = "ps -eo user,pid,cmd|grep fastchat.serve{}|grep -v grep|awk '{{logger.debug $2}}'|xargs kill -9"
...
logger.debug(f"llm api sever --{args.serve} has been shutdown!")
