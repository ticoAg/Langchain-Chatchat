...
if __name__ == "__main__":
    logger.debug("Luanching api_allinone，it would take a while, please be patient...")
    logger.debug("正在启动api_allinone，LLM服务启动约3-10分钟，请耐心等待...")
    # 初始化消息
    ...
    logger.debug("Luanching api_allinone done.")
    logger.debug("api_allinone启动完毕.")
